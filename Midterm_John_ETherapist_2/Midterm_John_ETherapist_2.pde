...
E Therapist - "Processing Feelings"

Welcome to your E therapist & Processing Feelings
begin at the opening screen and follow the options to communicate with
your e therapist

click the couch to begin

click the plant on the left or the drink on the right to move
...
//
 ...
 // }// else if (mouseX >=97 && mouseX <= 278 && mouseY>= 376 && mouseY <= 557){
   // image(plants,0,0);
    ...
    image(plants,0,0);
    ////////////////////////////
    text("i choose",width/2,height/2-210);
    text("to grow!",width/2, height/2-180);
    ////text("i'm doing pretty good",180,519);
    //text("(click the plant)",176,549);
    //text("not too hot",1087,464);
    //text("(click the glass)",1087,494);

}   else if (mouseX >=1053 && mouseX <= 1158 && mouseY>= 540 && mouseY <= 619){
    image(glass,0,0);
    text("i choose",width/2,height/2-210);
    text("negativity!",width/2,height/2-180);

} 

    else if (stage >= 2 && stage <= 34){
      image(office1,0,0);
      
    }else if (stage >= 2 && stage <= 34 && mouseX >=97 && mouseX <= 278 && mouseY>= 376 && mouseY <= 557){
    image(plants,0,0);
    } else if (stage >= 2 && stage <= 34 && mouseX >=1053 && mouseX <= 1158 && mouseY>= 540 && mouseY <= 619){
    image(glass,0,0);
    
//mouseX >=1053 && mouseX <= 1158 && mouseY>= 540 && mouseY <= 619)
  */
//}  
   /* } else if (stage >= 2 && stage <= 34 && mouseX >=97 && mouseX <= 278 && mouseY>= 376 && mouseY <= 557){
    image(plants,0,0);
...
//} else if (mouseX >=97 && mouseX <= 278 && mouseY>= 376 && mouseY <= 557){
  ...
  //////////////////////////////////////////////////////////////////////////////////
   //mouseX >=97 && mouseX <= 278 && mouseY>= 376 && mouseY <= 557)
    else if (mouseX >=97 && mouseX <= 278 && mouseY>= 376 && mouseY <= 557){
    image(plants,0,0);
...
/*    }else if (stage >= 2 && stage <= 34 && mouseX >=97 && mouseX <= 278 && mouseY>= 376 && mouseY <= 557){
    ...
    image(office1,0,0);*/
     ...
     //background(127);
     //image(office1,0,0);
     text("thanks for coming in",width/2,height/2-210);
     text("please make sure to pay your bill before you leave",width/2,height/2-180);
     text("todays bill is",width/2,height/2-150);
     text("thanks, see you next time",180,489);
