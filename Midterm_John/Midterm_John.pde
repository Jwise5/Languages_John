...
void draw(){
  ...
  if (stage==1){
    ...
    text("actually something cool happened (4)",width/4,height/2+100);
    ...
    background(175);
    text("that's awesome!",width/2,height/2-150);
    text("tell me about",width/2,height/2-100);
    text("ok... (5)",width/4,height/2+100);
    text("there's not much to tell",width/4*3,height/2+100);
  } else if (stage==6){
    background(200);
    text("just type what happened and how you're feeling",width/2,height/2-150);
    text("and press (!) once you've expressed yourself",width/2,height/2-100);
    text("i've said it all (!)",width/2,height/2+100);
  } //else if (
